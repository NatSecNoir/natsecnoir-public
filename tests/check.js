...
// Every page carries one nav.main: The file, Analyses, the lists.js keys in file order, Team Telecom, Restricted entities.
const listKeys = Object.keys((await import("../src/_data/lists.js")).default);
const expectedNav = ["The file", "/analyses/", ...listKeys.map((k) => `/by/list/${k}/`), "/analyses/team-telecom-agreements/", "Restricted entities"];
